...
```toml
#cargo.toml
rp-usb-serial = {version = "0.1.0",default-features = false, features = [ "rp2040"]}
```
[Example for rp2040](examples/rp2040_basic.rs)

### Example for rp2350
### RP2350平台使用例子
```toml
#cargo.toml
rp-usb-serial = {version = "0.1.0",default-features = false, features = [ "rp2350"]}
```

[Example for rp2350](examples/rp235x_basic.rs)
